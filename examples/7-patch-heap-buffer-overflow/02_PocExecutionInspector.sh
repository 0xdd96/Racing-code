...
python3 tracing.py "$EVAL_DIR/patch_trace -o outfile -Rf < @@" $EVAL_DIR/seed/poc $EVAL_DIR/temp_data/poc.addr

# Maps binary addresses to source code locations using addr2line.
python3 addr2line.py $EVAL_DIR/patch_trace $EVAL_DIR/temp_data/poc.addr $EVAL_DIR/temp_data/poc.addr2line
