...
cd $TOOL_DIR/scripts/
python3 tracing.py "$EVAL_DIR/cjpeg_trace -outfile /dev/null @@" $EVAL_DIR/seed/poc $EVAL_DIR/temp_data/poc.addr

# Maps binary addresses to source code locations using addr2line.
python3 addr2line.py $EVAL_DIR/cjpeg_trace $EVAL_DIR/temp_data/poc.addr $EVAL_DIR/temp_data/poc.addr2line
