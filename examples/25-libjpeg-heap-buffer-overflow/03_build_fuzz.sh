...
CC=$RACING_DIR/Racing-code/afl-clang-fast CXX=$RACING_DIR/Racing-code/afl-clang-fast++ CFLAGS="-g -O0 -fsanitize=address -poc_trace=$EVAL_DIR/temp_data/poc.addr2line" CXXFLAGS=$CFLAGS cmake -G "Unix Makefiles" -DBUILD_SHARED_LIBS=off ..
make
