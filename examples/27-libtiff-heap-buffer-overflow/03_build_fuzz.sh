...
CC=$RACING_DIR/Racing-code/afl-clang-fast LD=$CC CFLAGS="-g -O0 -fsanitize=address -poc_trace=$EVAL_DIR/temp_data/poc.addr2line" ./configure --disable-shared
make

mv $PWD/tools/tiffcrop $EVAL_DIR/tiffcrop_fuzz