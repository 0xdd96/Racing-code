...
CC=$RACING_DIR/afl-clang-fast CFLAGS="-g -O0 -fPIC -fsanitize=memory -poc_trace=$EVAL_DIR/temp_data/poc.addr2line"  LDFLAGS="-fsanitize=memory -fPIC -lm" LD=$CC ./minirake  $PWD/bin/mruby
