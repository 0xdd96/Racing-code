...
python3 tracing.py "$EVAL_DIR/objdump_trace -x @@" $EVAL_DIR/seed/obr1 $EVAL_DIR/temp_data/poc.addr

# Maps binary addresses to source code locations using addr2line.
python3 addr2line.py $EVAL_DIR/objdump_trace $EVAL_DIR/temp_data/poc.addr $EVAL_DIR/temp_data/poc.addr2line
