...
python3 tracing.py "$EVAL_DIR/fls_trace @@" $EVAL_DIR/seed/doublefree.img $EVAL_DIR/temp_data/poc.addr

# Maps binary addresses to source code locations using addr2line.
python3 addr2line.py $EVAL_DIR/fls_trace $EVAL_DIR/temp_data/poc.addr $EVAL_DIR/temp_data/poc.addr2line
