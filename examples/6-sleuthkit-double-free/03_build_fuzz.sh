...
CC=$RACING_DIR/afl-clang-fast CXX=$RACING_DIR/afl-clang-fast++ LD=$CC CFLAGS="-g -O0 -fPIE -poc_trace=$EVAL_DIR/temp_data/poc.addr2line" CXXFLAGS=$CFLAGS LDFLAGS=$CFLAGS ./configure --disable-shared
make
