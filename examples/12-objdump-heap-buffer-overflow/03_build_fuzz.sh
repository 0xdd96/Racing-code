...
CC=$RACING_DIR/Racing-code/afl-clang-fast LD=$CC CFLAGS="-g -O0 -fsanitize=address -Wno-error -poc_trace=$EVAL_DIR/temp_data/poc.addr2line" ./configure --disable-shared --disable-gdb --disable-libdecnumber --disable-readline --disable-sim --disable-ld --enable-targets=all
make
