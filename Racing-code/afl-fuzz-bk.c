...
static inline u8 has_new_crashes_values() {
  ...
  while(i--){
    ...
    //if (predicate_type[INST_SIZE+i]==HAS_EDGE_TO || predicate_type[INST_SIZE+i]==EDGE_ONLY_TAKEN_TO || predicate_type[INST_SIZE+i]==NUM_SUCCESSORS_GT) {
...
static inline u8 has_new_non_crashes_values() {
  ...
  while(i--){
    ...
    //if (predicate_type[INST_SIZE+i]==IS_VISITED || predicate_type[INST_SIZE+i]==HAS_EDGE_TO || predicate_type[INST_SIZE+i]==EDGE_ONLY_TAKEN_TO || predicate_type[INST_SIZE+i]==NUM_SUCCESSORS_GT) {
    if (predicate_type[INST_SIZE+i]==IS_VISITED || predicate_type[INST_SIZE+i]==HAS_EDGE_TO || predicate_type[INST_SIZE+i]==NUM_SUCCESSORS_GT) {
      u32 start_index = trace_bits->bb_start_index[i];
      u16 cnt_succ = trace_bits->bb_succ_cnt[i];
...
EXP_ST void setup_shm(void) {
  ...
  memset(predicate_type, 0, sizeof(enum Predicate) * (INST_SIZE+BB_SIZE));
